...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    dividendCalc: {
      ...
      intro: "Project future dividend income as payouts grow, with optional reinvestment (DRIP).",
      ...
      snapDps: "Annual dividend / share",
      snapYield: "Current yield",
      snapGrowth: "Suggested growth",
      assumptionsTitle: "Assumptions",
      assumptionsDesc: "Adjust to your own expectations. All amounts in the stock's currency.",
      dps: "Annual dividend per share",
      dpsHint: "Current yearly dividend paid per share.",
      growth: "Dividend growth (%/yr)",
      growthHint: "Expected annual increase of the dividend.",
      shares: "Shares owned",
      price: "Share price",
      priceHint: "Used for yield-on-cost and reinvestment.",
      years: "Years to project",
      reinvest: "Reinvest dividends (DRIP)",
      reinvestHint: "Buy more shares with each payout.",
      priceGrowth: "Share price growth (%/yr)",
      priceGrowthHint: "Reinvestment buys at this rising price.",
      resultTitle: "Projection",
      resultDisclaimer: "Illustrative only; not investment advice.",
      needInputs: "Enter positive shares and price to project income.",
      finalIncome: "Annual income (final year)",
      totalIncome: "Total dividends collected",
      finalYoc: "Yield on cost (final)",
  ...
  bg: {
    ...
    dividendCalc: {
      title: "Калкулатор за ръст на дивиденти",
      intro: "Прогнозирай бъдещ дивидентен доход с растящи изплащания и опционално реинвестиране (DRIP).",
      ...
      snapshotTitle: "Резюме",
      snapDps: "Годишен дивидент / акция",
      snapYield: "Текуща доходност",
      snapGrowth: "Препоръчан ръст",
      assumptionsTitle: "Допускания",
      assumptionsDesc: "Настрой според очакванията си. Всички суми са във валутата на акцията.",
      dps: "Годишен дивидент на акция",
      dpsHint: "Текущ годишен дивидент на акция.",
      growth: "Ръст на дивидента (%/год.)",
      growthHint: "Очаквано годишно увеличение на дивидента.",
      shares: "Брой акции",
      price: "Цена на акция",
      priceHint: "За доходност спрямо цена и реинвестиране.",
      years: "Години на прогноза",
      reinvest: "Реинвестирай дивидентите (DRIP)",
      reinvestHint: "Купувай още акции с всяко изплащане.",
      priceGrowth: "Ръст на цената (%/год.)",
      priceGrowthHint: "Реинвестирането купува на тази растяща цена.",
      resultTitle: "Прогноза",
      resultDisclaimer: "Само илюстративно; не е инвестиционен съвет.",
      needInputs: "Въведи положителен брой акции и цена.",
      finalIncome: "Годишен доход (последна година)",
      totalIncome: "Общо събрани дивиденти",
      finalYoc: "Доходност спрямо цена (накрая)",
