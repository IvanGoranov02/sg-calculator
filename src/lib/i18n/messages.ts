...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    dashboard: {
      title: "Dashboard",
      welcome:
        "Live benchmarks, headlines, and portfolio dividend activity at a glance.",
      newsTitle: "Market headlines",
  ...
  bg: {
    ...
    dashboard: {
      title: "Табло",
      welcome:
        "Котировки, новини и дивиденти от портфолиото на един поглед.",
      newsTitle: "Пазарни новини",
