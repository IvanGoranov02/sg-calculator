...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    chartsFund: {
      ...
      loadedDataSpan:
        "Yahoo fundamentals in this view span {fromYear}–{toYear} ({n} {unit}). Depth varies by symbol — not an app limit.",
  ...
  bg: {
    ...
    chartsFund: {
      ...
      loadedDataSpan:
        "Фундаментите от Yahoo в този изглед са {fromYear}–{toYear} ({n} {unit}). Дълбочината зависи от символа — не е лимит на приложението.",
      filterPresetNoNarrow:
