...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    dashboard: {
      ...
      nameSpy: "S&P 500",
      nameQqq: "Nasdaq-100",
      nameWti: "WTI crude oil",
      nameBrent: "Brent crude oil",
      nameGold: "Gold",
      nameSilver: "Silver",
      ...
      commoditiesAria: "Commodity quotes",
    ...
    dcf: {
      ...
      entryForReturn: "Entry price for {pct}% return",
      entryHint: "Max buy price today for your desired return to a {years}-year target of {target}.",
      epsChartProjectedPrice: "Projected price",
      epsChartHorizonNote: "{years}-year projection · labels at Q1 each year",
      chartToday: "Today",
      epsErr: {
        eps_non_positive: "TTM EPS must be positive.",
        growth_rate_invalid: "Enter a growth rate (must be above −100%).",
        pe_non_positive: "P/E multiple must be positive.",
        pe_out_of_range: "P/E multiple must be between 0.1× and 500×.",
        desired_return_invalid: "Desired return must be between 0% and 100%.",
        horizon_invalid: "Projection horizon is invalid.",
      },
  ...
  bg: {
    ...
    dashboard: {
      ...
      nameSpy: "S&P 500",
      nameQqq: "Nasdaq-100",
      nameWti: "WTI суров петрол",
      nameBrent: "Brent суров петрол",
      nameGold: "Злато",
      nameSilver: "Сребро",
      ...
      commoditiesAria: "Котировки за суровини",
    ...
    dcf: {
      ...
      entryForReturn: "Входна цена за {pct}% доходност",
      entryHint: "Макс. цена днес за желаната доходност до цел {target} след {years} г.",
      epsChartProjectedPrice: "Прогнозна цена",
      epsChartHorizonNote: "Прогноза за {years} г. · маркери Q1 всяка година",
      chartToday: "Днес",
      epsErr: {
        eps_non_positive: "TTM EPS трябва да е положителен.",
        growth_rate_invalid: "Въведете темп на растеж (над −100%).",
        pe_non_positive: "P/E множителят трябва да е положителен.",
        pe_out_of_range: "P/E множителят трябва да е между 0,1× и 500×.",
        desired_return_invalid: "Желаната доходност трябва да е между 0% и 100%.",
        horizon_invalid: "Невалиден хоризонт на прогнозата.",
      },
