...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    portfolioAnalytics: {
      ...
      allocationDesc: "Share of portfolio value (in {base}).",
      sectorTitle: "Sector allocation",
      sectorDesc: "Share of portfolio value by sector.",
  ...
  bg: {
    ...
    portfolioAnalytics: {
      ...
      allocationDesc: "Дял от стойността на портфейла (в {base}).",
      sectorTitle: "Разпределение по сектор",
      sectorDesc: "Дял от стойността на портфейла по сектор.",
