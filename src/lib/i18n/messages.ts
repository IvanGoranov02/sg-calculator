...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    watchlist: {
      ...
      dipTitle: "Dip finder",
      dipSubtitle:
        "Price vs the SMA of the selected lookback. Red: below average. Green: above. 200-day SMA stays as a comparison.",
      dipVsSma: "vs 200 SMA",
  ...
  bg: {
    ...
    watchlist: {
      ...
      dipTitle: "Dip finder",
      dipSubtitle:
        "Цена спрямо SMA за избрания период. Червено: под средната. Зелено: над. 200-дневната SMA остава за сравнение.",
