...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    admin: {
      ...
      loading: "Loading…",
      emptyList: "No cached symbols yet. Open a stock page to populate the cache.",
      colSymbol: "Symbol",
      colName: "Name",
      colUpdated: "Updated",
      colActions: "Actions",
      ...
      save: "Save changes",
      saved: "Saved.",
      refreshed: "Re-fetched from source data.",
      tabQuote: "Quote",
      tabAnnual: "Annual",
      tabQuarterly: "Quarterly",
      tabInvestor: "Investor",
      tabMeta: "Meta",
      incomeAnnual: "Income (annual)",
      cashFlowAnnual: "Cash flow (annual)",
      balanceAnnual: "Balance sheet (annual)",
      incomeQuarterly: "Income (quarterly)",
      cashFlowQuarterly: "Cash flow (quarterly)",
      balanceQuarterly: "Balance sheet (quarterly)",
      dividendQuarterly: "Dividends (quarterly)",
      addRow: "Add row",
      created: "Created",
      updated: "Updated",
    ...
    dashboard: {
      title: "Dashboard",
      welcome: "Markets, headlines, and portfolio dividends in one place.",
      newsTitle: "Top stories",
      newsDesc: "Major stories moving US equities and macro.",
      newsEmpty: "Headlines are unavailable right now. Try again later.",
      benchSpy: "S&P 500",
      benchQqq: "Nasdaq 100",
      benchGold: "Gold",
      benchSilver: "Silver",
      ...
      benchBrent: "Brent",
      indicesTab: "Indices",
      overviewAria: "World indices and commodities",
      chartAria: "S&P 500 chart",
      heatmapAria: "S&P 500 sector heatmap",
      eventsLink: "Full events calendar →",
      divTitle: "Portfolio dividends",
      divDesc: "Last three payouts and the next three ex-div or pay dates from your holdings.",
      divSignInDesc: "Sign in and add holdings to see dividend history and upcoming dates.",
      divViewAll: "All dividends",
      divLoading: "Loading dividend data…",
      divLoadError: "Could not load portfolio or dividend data. Try again later.",
      divUpcomingLoading: "Loading upcoming dates…",
      divNoHoldingsBefore: "No holdings yet.",
      divNoHoldingsLink: "Add holdings",
      divNoHoldingsAfter: "to track payouts and upcoming dates.",
      divRecentAria: "Recent dividend payments",
      divRecentTitle: "Last 3 paid",
      divRecentEmpty: "No dividend payments recorded for your portfolio yet.",
      divUpcomingAria: "Upcoming dividend dates",
      divUpcomingTitle: "Next 3 dates",
      divUpcomingEmpty: "No upcoming ex-dividend or pay dates found for your holdings.",
      divEventsError: "Could not load upcoming dividend dates.",
      ...
      marketOilHint: "WTI crude oil futures — news-sensitive macro input.",
      marketBrentHint: "Brent crude futures — global oil benchmark.",
      marketGoldHint: "Gold futures — defensive commodity benchmark.",
      marketSilverHint: "Silver futures — industrial and precious metal.",
      assetsAria: "Commodities and currency quotes",
      commoditiesTab: "Commodities",
      currenciesTab: "Currencies",
      fxEurUsdHint: "Euro to US dollar spot rate.",
      fxGbpUsdHint: "British pound to US dollar spot rate.",
      fxUsdJpyHint: "US dollar to Japanese yen spot rate.",
      fxUsdBgnHint: "US dollar to Bulgarian lev spot rate.",
      oilNewsTitle: "Oil news context",
      oilNewsFallback: "Oil reacts quickly to macro and geopolitical news.",
    ...
    chartsFund: {
      ...
      periodFilterTablesHint:
        "Fiscal year columns follow the range under Fundamentals (fixed count for 1y–5y). Dashes mean no data for that year in the feed.",
      ...
      filterPresetShorterThanRequestedAnnual:
        "You chose up to {presetYears} calendar years, but the loaded series only has {n} {unit} ({fromYear}–{toYear}, {loadedSpanYears} calendar years). The chart shows everything in the feed — not a filter bug.",
      filterPresetShorterThanRequestedQuarterly:
        "You chose up to {presetYears} calendar years of quarters (up to {maxQuarters} bars when data exists). Each column is one fiscal quarter. Here the feed only has {n} {unit} ({fromYear}–{toYear}, {loadedSpanYears} calendar years), so the chart shows all of them — not a filter bug.",
      ...
      chartNetIncomeSoloDesc: "Bottom-line profit as columns (as reported).",
    ...
    watchlist: {
      ...
      dipRange_1y: "1y",
      sma200: "200 SMA",
      dipNoData: "Not enough history to plot a dip for these quotes.",
    },
    portfolio: {
      title: "Portfolio",
      subtitle:
      ...
      colDip: "Dip vs 200d",
      colEarnings: "Next earnings",
      dipHint: "Price vs 200-day average. Negative = trading below trend (a dip).",
      sourceManual: "Manual",
      ...
      t212DivEmpty: "No Trading 212 dividend history yet.",
      t212DivNotConnected: "Connect Trading 212 to load paid dividends.",
      t212DivError: "Could not load Trading 212 dividends.",
      t212DivColTicker: "Ticker",
      t212DivColAmount: "Amount",
      t212DivColCurrency: "Currency",
      t212DivColPaidOn: "Paid on",
      ...
      valueSourceT212: "Source: Trading 212",
      valueSourceComputed: "Source: estimated from holdings",
      ...
      valueManualDelete: "Remove manual value",
      valueManualSaveFailed: "Could not save monthly portfolio value.",
      valueManualDeleteFailed: "Could not remove monthly portfolio value.",
    },
    portfolioDividends: {
      ...
      source: "Source",
      manualTitle: "Add manual dividend",
    ...
    ai: {
      ...
      loadingFiltersHint: "Uses your fundamentals period and annual/quarterly setting.",
      refreshing: "Updating for new filters…",
    ...
    dcf: {
      ...
      intro:
        "GuruFocus-style two-stage model: discount projected EPS (or FCF / dividend) at a growth rate, then a slower terminal stage. Fair value = intrinsic value + optional tangible book.",
      seedLine: "{symbol} · {name} · market {price}",
      noSeed: "No data for {ticker}. Enter manually or pick another ticker.",
      snapshotTitle: "Per-share snapshot",
      snapshotDesc: "Latest reported figures used to seed the calculator.",
      snapEps: "Trailing EPS",
      snapEpsSub: "quote trailing EPS or latest diluted EPS",
      snapFcf: "FCF / share",
      snapFcfSub: "free cash flow / shares",
      snapDividend: "Dividend / share",
      snapTangibleBook: "Tangible book / share",
      snapSuggestedGrowth: "Suggested growth (10y)",
      assumptionsTitle: "DCF assumptions",
      assumptionsDesc: "Enter percents as numbers: 10 = 10%. Defaults follow GuruFocus (10y growth + 10y terminal @ 4%).",
      basedOn: "Based on",
      baseEps: "Trailing EPS",
      baseFcf: "FCF / share",
      baseDividend: "Dividend / share",
      baseHint: "Current per-share base for the DCF (E₀). EPS uses trailing or diluted figures from Yahoo.",
      discount: "Discount rate %",
      discountHint: "Required return / discount rate (d). Terminal growth must stay below this.",
      growthYears: "Growth stage years",
      growthRate: "Growth stage rate %",
      terminalYears: "Terminal stage years",
      terminalGrowth: "Terminal growth rate %",
      addTangibleBook: "Add tangible book value to fair value",
      tangibleBook: "Tangible book / share",
      resultTitle: "Result",
      resultDisclaimer: "Illustrative only; not investment advice.",
      needInputs: "Could not compute a result with the current inputs.",
      err: {
        discount_required: "Enter a discount rate (%).",
        discount_invalid: "Discount rate must be between 0% and 100%.",
        terminal_growth_vs_discount:
          "Terminal growth must be strictly below the discount rate (g₂ < d).",
        base_non_positive: "Per-share base must be positive to run the DCF.",
        invalid_years: "Growth and terminal years must be zero or greater.",
      },
      growthValue: "Growth-stage value",
      terminalValue: "Terminal-stage value",
      intrinsicValue: "Intrinsic value (DCF)",
      fairValue: "Fair value / share",
      includesTbv: "Includes tangible book: {v}",
      stockPrice: "Stock price",
      marginOfSafety: "Margin of safety",
      detailPv: "Detail · PV breakdown",
      pvGrowth: "Growth-stage PV: {v}",
      pvTerminal: "Terminal-stage PV: {v}",
      chartProjectedTitle: "Projected cash flows by year",
      chartProjectedDesc: "Projected {metric} in each forecast year.",
      chartProjected: "Projected",
      chartCumulativeTitle: "Cumulative present value",
      chartCumulativeDesc: "Running sum of discounted yearly flows.",
      chartCumulative: "Cumulative PV",
      chartValuationTitle: "Fair value vs price",
      chartValuationDesc: "Intrinsic fair value compared to the current quote.",
      chartFairValue: "Fair value",
      chartPrice: "Price",
      chartUpside: "Upside vs price: {pct}",
    },
    dividendCalc: {
      title: "Dividend calculator",
      intro: "Estimate future dividend income with contributions, optional DRIP, and growth assumptions.",
      seedLine: "Seeded from {symbol} · {name} · price {price}",
      growthFromHistory: "growth from dividend history",
      noSeed: "No live data for {ticker}; enter the figures manually below.",
      inputsTitle: "Inputs",
      inputsDesc: "Adjust to your expectations. All amounts in the stock's currency.",
      price: "Unit / stock price",
      shares: "Number of stocks",
      holdingPeriod: "Holding period",
      holdingPeriodHint: "How many years will you hold this dividend portfolio? (up to 40 years)",
      yearOne: "1 year",
      yearMany: "{count} years",
      yield: "Annual dividend yield",
      yieldHint: "Dividend income per year for every dollar invested.",
      yieldSeedHint: "Live yield: {yield}",
      contribution: "Annual contribution",
      contributionHint: "Cash added to the portfolio each year.",
      growth: "Expected dividend growth rate",
      growthHint: "Estimated annual increase in dividend payouts (often 3–5%).",
      reinvest: "Dividend reinvestment plan",
      reinvestHint: "Reinvest dividends to buy more shares (DRIP).",
      reinvestYes: "Yes",
      reinvestNo: "No",
      priceGrowth: "Expected annual stock appreciation",
      priceGrowthHint: "Expected yearly share price increase (often 6–8%).",
      resultTitle: "Estimated dividend return",
      resultDisclaimer: "Illustrative only; not investment advice.",
      needInputs: "Enter a positive stock price and number of stocks.",
      estimatedReturn: "Estimated dividend return",
      breakdownDividends: "Dividends",
      breakdownContributions: "Contributions",
      breakdownGrowth: "Growth",
      breakdownPrincipal: "Principal",
      incomeTableTitle: "Year-by-year monthly income",
      tableYear: "Year",
      tableMonthly: "Monthly income",
      finalShares: "Projected shares after reinvestment: {shares}",
      finalPortfolio: "Portfolio value: {value}",
      annualIncome: "Annual income",
      cumulativeDividends: "Cumulative dividends",
      portfolioValue: "Portfolio value",
      yearLabel: "Year {year}",
      chartCumulative: "Cumulative dividends",
      chartPortfolio: "Portfolio value over time",
      chartAnnualIncome: "Annual dividend income",
      chartComposition: "Portfolio composition",
      chartMonthly: "Monthly dividend income",
    },
    events: {
      title: "Events",
      intro: "Upcoming earnings, ex-dividend, and dividend pay dates for your watchlist and portfolio.",
      loading: "Loading events…",
      error: "Could not load events.",
      noneUpcoming: "No upcoming events found for your watchlist or portfolio.",
      noDate: "No known dates ({count})",
      today: "Today",
      yesterday: "Yesterday",
      daysAgo: "{days} days ago",
      tomorrow: "Tomorrow",
      inDays: "in {days} days",
      kindEarnings: "Earnings",
      kindExDiv: "Ex-div",
      kindPay: "Pay date",
      estDividend: "Est. dividend",
      emptyTitle: "Nothing to show yet",
      emptyDescBefore: "Add stocks to your",
      emptyWatchlistLink: "watchlist",
      emptyDescMiddle: "or",
      emptyPortfolioLink: "portfolio",
      emptyDescAfter: " to see upcoming events here.",
    },
    compare: {
      title: "Compare stocks",
      intro: "Two companies, side by side. Charts for the main metrics — the stronger reading is marked.",
      addPlaceholder: "Search ticker",
      remove: "Remove {symbol}",
      changeTicker: "Change {symbol}",
      slotMissing: "Couldn't load this ticker.",
      vs: "vs",
      slotLabel: "Company {n}",
      metric: "Metric",
      empty: "Add a ticker in each slot to compare them.",
      error: "Could not load comparison data.",
      unresolved: "Couldn't load: {symbols}. Check the ticker (e.g. BRK-B).",
      footnote: "Yahoo snapshot metrics only — not a recommendation.",
      chartsTitle: "Main metrics",
      chartsHint:
        "Grouped charts plus a card per metric. Bar length is the larger number in the pair — not always the better reading.",
      chartMargins: "Margins",
      chartMarginsHint: "Gross, operating, and net margin, side by side.",
      chartGrowth: "Growth",
      chartGrowthHint: "Year-over-year revenue and earnings growth.",
      numbersTitle: "All numbers",
      perfLead: "Over the past 12 months, {winner} returned {winnerRet} versus {loser} at {loserRet}.",
      leadsTitle: "At a glance",
      leadsHint: "Who stands out in each group from the charts above. Not a buy or sell call.",
      noLead: "No clear lead",
      groupValuation: "Valuation",
      groupProfit: "Profitability",
      groupGrowth: "Growth",
      groupBalance: "Balance sheet",
      groupIncome: "Income",
      groupMarket: "Market",
      weekChange: "52-week change",
      weekChangeShort: "52w {value}",
      weekPosition: "Place in 52w range",
    ...
    portfolioAnalytics: {
      ...
      yieldOnValue: "{pct}% on value",
      holdings: "Holdings",
      unconverted: "{n} not converted (no FX)",
      allocationTitle: "Allocation by holding",
  ...
  bg: {
    ...
    nav: {
      ...
      dividendCalculator: "Дивидентен калкулатор",
      events: "Събития",
      compare: "Сравнение",
      watchlist: "Списък",
      portfolio: "Портфолио",
    ...
    admin: {
      ...
      loading: "Зареждане…",
      emptyList: "Няма кеширани символи. Отвори страница на акция, за да се попълни кешът.",
      colSymbol: "Символ",
      colName: "Име",
      colUpdated: "Обновено",
      colActions: "Действия",
      ...
      save: "Запази",
      saved: "Запазено.",
      refreshed: "Обновено от източника.",
      tabQuote: "Котировка",
      tabAnnual: "Годишни",
      tabQuarterly: "Тримесечни",
      tabInvestor: "Инвестор",
      tabMeta: "Мета",
      incomeAnnual: "Приходи (годишни)",
      cashFlowAnnual: "Паричен поток (годишен)",
      balanceAnnual: "Баланс (годишен)",
      incomeQuarterly: "Приходи (тримесечни)",
      cashFlowQuarterly: "Паричен поток (тримесечен)",
      balanceQuarterly: "Баланс (тримесечен)",
      dividendQuarterly: "Дивиденти (тримесечни)",
      addRow: "Добави ред",
      created: "Създадено",
      updated: "Обновено",
    ...
    dashboard: {
      title: "Табло",
      welcome: "Пазари, новини и дивиденти от портфолиото на едно място.",
      newsTitle: "Топ новини",
      newsDesc: "Важни теми за US акции и макро.",
      newsEmpty: "Новините не са налични в момента. Опитайте по-късно.",
      benchSpy: "S&P 500",
      benchQqq: "Nasdaq 100",
      benchGold: "Злато",
      benchSilver: "Сребро",
      ...
      benchBrent: "Brent",
      indicesTab: "Индекси",
      overviewAria: "Световни индекси и суровини",
      chartAria: "Графика на S&P 500",
      heatmapAria: "Топлинна карта на S&P 500",
      eventsLink: "Пълен календар →",
      divTitle: "Дивиденти от портфолио",
      divDesc: "Последните три изплащания и следващите три ex-div или pay дати от вашите позиции.",
      divSignInDesc: "Влезте и добавете позиции, за да виждате история и предстоящи дати.",
      divViewAll: "Всички дивиденти",
      divLoading: "Зареждане на дивиденти…",
      divLoadError: "Неуспешно зареждане на портфолио или дивидентни данни. Опитайте по-късно.",
      divUpcomingLoading: "Зареждане на предстоящи дати…",
      divNoHoldingsBefore: "Все още няма позиции.",
      divNoHoldingsLink: "Добавете позиции",
      divNoHoldingsAfter: "за проследяване на изплащания и дати.",
      divRecentAria: "Последни дивидентни плащания",
      divRecentTitle: "Последни 3",
      divRecentEmpty: "Няма записани дивидентни плащания за портфолиото.",
      divUpcomingAria: "Предстоящи дивидентни дати",
      divUpcomingTitle: "Следващи 3",
      divUpcomingEmpty: "Няма предстоящи ex-div или pay дати за вашите позиции.",
      divEventsError: "Неуспешно зареждане на предстоящи дивидентни дати.",
      ...
      marketOilHint: "WTI петролни фючърси — чувствителен към новини макро индикатор.",
      marketBrentHint: "Brent фючърси — глобален петролен ориентир.",
      marketGoldHint: "Фючърси върху злато — защитна суровина.",
      marketSilverHint: "Фючърси върху сребро — индустриален и благороден метал.",
      assetsAria: "Котировки за суровини и валути",
      commoditiesTab: "Суровини",
      currenciesTab: "Валути",
      fxEurUsdHint: "Спот курс евро към щатски долар.",
      fxGbpUsdHint: "Спот курс британски паунд към щатски долар.",
      fxUsdJpyHint: "Спот курс щатски долар към японска йена.",
      fxUsdBgnHint: "Спот курс щатски долар към български лев.",
      oilNewsTitle: "Контекст за петрола",
      oilNewsFallback: "Петролът реагира бързо на макро и геополитически новини.",
    ...
    stock: {
      ...
      subtitle: "Фундаментали + котировки на живо.",
    ...
    chartsFund: {
      ...
      filterPresetShorterThanRequestedAnnual:
        "Избран е прозорец до {presetYears} календарни години, но заредената серия има само {n} {unit} ({fromYear}–{toYear}, {loadedSpanYears} календарни години). Графиката показва всичко от потока — не е грешка във филтъра.",
      filterPresetShorterThanRequestedQuarterly:
        "Избран е прозорец до {presetYears} календарни години тримесечия (до {maxQuarters} колони, ако има данни). Всяка колона е едно фискално тримесечие. Тук потокът има само {n} {unit} ({fromYear}–{toYear}, {loadedSpanYears} календарни години), затова графиката показва всички налични — не е грешка във филтъра.",
      ...
      chartNetIncomeSoloDesc: "Печалба след всички разходи в колони (както са отчетени).",
    ...
    watchlist: {
      ...
      dipRange_1y: "1г",
      sma200: "200 SMA",
      dipNoData: "Няма достатъчно история за dip при тези котировки.",
    },
    portfolio: {
      title: "Портфолио",
      subtitle:
      ...
      colDip: "Dip спр. 200д",
      colEarnings: "Следващ отчет",
      dipHint: "Цена спрямо 200-дневна средна. Отрицателно = търгува се под тренда (dip).",
      sourceManual: "Ръчно",
      sourceT212: "Trading 212",
      quoteMissing: "—",
      divDisclaimer:
      ...
      t212DivEmpty: "Все още няма история на дивиденти от Trading 212.",
      t212DivNotConnected: "Свържи Trading 212, за да се заредят платените дивиденти.",
      t212DivError: "Неуспешно зареждане на дивиденти от Trading 212.",
      t212DivColTicker: "Тикер",
      t212DivColAmount: "Сума",
      t212DivColCurrency: "Валута",
      t212DivColPaidOn: "Платено на",
      tabHoldings: "Позиции",
      ...
      valueSourceT212: "Източник: Trading 212",
      valueSourceComputed: "Източник: оценка от позиции",
      ...
      valueManualDelete: "Премахни ръчна стойност",
      valueManualSaveFailed: "Неуспешно записване на месечна стойност.",
      valueManualDeleteFailed: "Неуспешно премахване на месечна стойност.",
    },
    portfolioDividends: {
      ...
      source: "Източник",
      manualTitle: "Добави дивидент ръчно",
      manualHint: "Запиши дивидент, получен извън синхронизацията с Trading 212.",
    ...
    ai: {
      ...
      loadingFiltersHint: "Съобразено с периода и годишно/тримесечно от фундаменталите.",
      refreshing: "Обновяване при нови филтри…",
    ...
    dcf: {
      ...
      intro:
        "Двуетапен модел в стил GuruFocus: дисконтирани прогнозни EPS (или FCF / дивидент) с ръст, след това по-бавен терминален етап. Справедлива стойност = вътрешна стойност + опционална материална балансова стойност.",
      seedLine: "{symbol} · {name} · пазар {price}",
      noSeed: "Няма данни за {ticker}. Въведете ръчно или изберете друг тикер.",
      snapshotTitle: "Снимка на акция",
      snapshotDesc: "Последни отчетни стойности за начални параметри.",
      snapEps: "Trailing EPS",
      snapEpsSub: "trailing EPS от котировка или последен diluted EPS",
      snapFcf: "FCF / акция",
      snapFcfSub: "свободен паричен поток / акции",
      snapDividend: "Дивидент / акция",
      snapTangibleBook: "Материална балансова / акция",
      snapSuggestedGrowth: "Препоръчан ръст (10г.)",
      assumptionsTitle: "Допускания за DCF",
      assumptionsDesc: "Процентите са като числа: 10 = 10%. По подразбиране: 10г. ръст + 10г. терминал @ 4%.",
      basedOn: "Базирано на",
      baseEps: "Trailing EPS",
      baseFcf: "FCF / акция",
      baseDividend: "Дивидент / акция",
      baseHint: "Текуща стойност на акция за DCF (E₀). EPS е trailing или diluted от Yahoo.",
      discount: "Дисконтна ставка %",
      discountHint: "Изискана доходност (d). Терминалният ръст трябва да е под нея.",
      growthYears: "Години на растеж",
      growthRate: "Ръст в растежен етап %",
      terminalYears: "Години на терминал",
      terminalGrowth: "Терминален ръст %",
      addTangibleBook: "Добави материална балансова стойност",
      tangibleBook: "Материална балансова / акция",
      resultTitle: "Резултат",
      resultDisclaimer: "Илюстративно; не е инвестиционен съвет.",
      needInputs: "Неуспешно изчисление с текущите входни данни.",
      err: {
        discount_required: "Въведете дисконтна ставка (%).",
        discount_invalid: "Дисконтната ставка трябва да е между 0% и 100%.",
        terminal_growth_vs_discount:
          "Терминалният ръст трябва да е строго под дисконтната ставка (g₂ < d).",
        base_non_positive: "Базовата стойност на акция трябва да е положителна за DCF.",
        invalid_years: "Годините на растеж и терминал трябва да са ≥ 0.",
      },
      growthValue: "Стойност на растежен етап",
      terminalValue: "Терминална стойност",
      intrinsicValue: "Вътрешна стойност (DCF)",
      fairValue: "Справедлива стойност / акция",
      includesTbv: "Включва материална балансова: {v}",
      stockPrice: "Цена на акция",
      marginOfSafety: "Марж на сигурност",
      detailPv: "Детайл · PV разбивка",
      pvGrowth: "PV на растежен етап: {v}",
      pvTerminal: "PV на терминален етап: {v}",
      chartProjectedTitle: "Прогнозни потоци по години",
      chartProjectedDesc: "Прогнозен {metric} за всяка година.",
      chartProjected: "Прогноза",
      chartCumulativeTitle: "Кумулативна настояща стойност",
      chartCumulativeDesc: "Нарастваща сума от дисконтирани годишни потоци.",
      chartCumulative: "Кумулативен PV",
      chartValuationTitle: "Справедлива стойност срещу цена",
      chartValuationDesc: "Вътрешна справедлива стойност спрямо текущата котировка.",
      chartFairValue: "Справедлива",
      chartPrice: "Цена",
      chartUpside: "Потенциал спрямо цената: {pct}",
    },
    dividendCalc: {
      title: "Дивидентен калкулатор",
      intro: "Оцени бъдещ дивидентен доход с вноски, опционален DRIP и допускания за растеж.",
      seedLine: "Данни от {symbol} · {name} · цена {price}",
      growthFromHistory: "ръст от историята на дивидентите",
      noSeed: "Няма данни на живо за {ticker}; въведи стойностите ръчно по-долу.",
      inputsTitle: "Входни данни",
      inputsDesc: "Настрой според очакванията си. Всички суми са във валутата на акцията.",
      price: "Цена на акция",
      shares: "Брой акции",
      holdingPeriod: "Период на държане",
      holdingPeriodHint: "Колко години ще държиш портфолиото? (до 40 години)",
      yearOne: "1 година",
      yearMany: "{count} години",
      yield: "Годишна дивидентна доходност",
      yieldHint: "Дивидентен доход на година за всеки вложен долар.",
      yieldSeedHint: "Текуща доходност: {yield}",
      contribution: "Годишна вноска",
      contributionHint: "Пари, добавени към портфолиото всяка година.",
      growth: "Очакван ръст на дивидента",
      growthHint: "Очаквано годишно увеличение на дивидентите (често 3–5%).",
      reinvest: "План за реинвестиране на дивиденти",
      reinvestHint: "Реинвестирай дивидентите за покупка на още акции (DRIP).",
      reinvestYes: "Да",
      reinvestNo: "Не",
      priceGrowth: "Очаквана годишна оценка на акцията",
      priceGrowthHint: "Очаквано годишно покачване на цената (често 6–8%).",
      resultTitle: "Очаквана дивидентна възвращаемост",
      resultDisclaimer: "Само илюстративно; не е инвестиционен съвет.",
      needInputs: "Въведи положителна цена и брой акции.",
      estimatedReturn: "Очаквана дивидентна възвращаемост",
      breakdownDividends: "Дивиденти",
      breakdownContributions: "Вноски",
      breakdownGrowth: "Ръст",
      breakdownPrincipal: "Основна сума",
      incomeTableTitle: "Месечен доход по години",
      tableYear: "Година",
      tableMonthly: "Месечен доход",
      finalShares: "Прогнозни акции след реинвестиране: {shares}",
      finalPortfolio: "Стойност на портфолиото: {value}",
      annualIncome: "Годишен доход",
      cumulativeDividends: "Натрупани дивиденти",
      portfolioValue: "Стойност на портфолиото",
      yearLabel: "Година {year}",
      chartCumulative: "Натрупани дивиденти",
      chartPortfolio: "Стойност на портфолиото във времето",
      chartAnnualIncome: "Годишен дивидентен доход",
      chartComposition: "Състав на портфолиото",
      chartMonthly: "Месечен дивидентен доход",
    },
    events: {
      title: "Събития",
      intro: "Предстоящи отчети, ex-div и дати на дивидент за твоя watchlist и портфолио.",
      loading: "Зареждане на събитията…",
      error: "Неуспешно зареждане на събитията.",
      noneUpcoming: "Няма предстоящи събития в твоя watchlist или портфолио.",
      noDate: "Без известни дати ({count})",
      today: "Днес",
      yesterday: "Вчера",
      daysAgo: "преди {days} дни",
      tomorrow: "Утре",
      inDays: "след {days} дни",
      kindEarnings: "Печалба",
      kindExDiv: "Ex-div",
      kindPay: "Дивидент",
      estDividend: "Очакв. дивидент",
      emptyTitle: "Все още няма какво да се покаже",
      emptyDescBefore: "Добави акции към своя",
      emptyWatchlistLink: "watchlist",
      emptyDescMiddle: "или",
      emptyPortfolioLink: "портфолио",
      emptyDescAfter: ", за да видиш предстоящите събития тук.",
    },
    compare: {
      title: "Сравнение на акции",
      intro: "Две компании една до друга. Графики за основните метрики — по-силната стойност е откроена.",
      addPlaceholder: "Търси тикер",
      remove: "Премахни {symbol}",
      changeTicker: "Смени {symbol}",
      slotMissing: "Неуспешно зареждане на този тикер.",
      vs: "срещу",
      slotLabel: "Компания {n}",
      metric: "Метрика",
      empty: "Добави тикер във всеки слот, за да ги сравниш.",
      error: "Неуспешно зареждане на данните за сравнение.",
      unresolved: "Неуспешно зареждане: {symbols}. Провери тикера (напр. BRK-B).",
      footnote: "Само Yahoo снимка на метриките — не е препоръка.",
      chartsTitle: "Основни метрики",
      chartsHint:
        "Групирани графики и карта за всяка метрика. Дължината на лентата е по-голямото число в двойката — не винаги по-добрата стойност.",
      chartMargins: "Маржове",
      chartMarginsHint: "Брутен, оперативен и нетен марж, една до друга.",
      chartGrowth: "Растеж",
      chartGrowthHint: "Годишен ръст на приходите и печалбата.",
      numbersTitle: "Всички числа",
      perfLead: "През последните 12 месеца {winner} върна {winnerRet} срещу {loser} с {loserRet}.",
      leadsTitle: "Накратко",
      leadsHint: "Кой изпъква в групата според графиките по-горе. Не е съвет за покупка или продажба.",
      noLead: "Няма ясен лидер",
      groupValuation: "Оценка",
      groupProfit: "Рентабилност",
      groupGrowth: "Растеж",
      groupBalance: "Баланс",
      groupIncome: "Доход",
      groupMarket: "Пазар",
      weekChange: "Промяна за 52 седмици",
      weekChangeShort: "52с {value}",
      weekPosition: "Място в 52-седм. диапазон",
      weekRange: "52-седмичен диапазон",
      analystUpside: "Потенциал според анализатори",
      analysts: "Анализатори",
      roa: "Възвръщаемост на активите",
      evRevenue: "EV / продажби",
      currentRatio: "Текуща ликвидност",
      quickRatio: "Бърза ликвидност",
      epsTrailing: "EPS (TTM)",
      payout: "Коефициент на изплащане",
      totalCash: "Парични средства",
      totalDebt: "Общ дълг",
      marketCap: "Пазарна капитализация",
      ...
      peg: "PEG съотношение",
      ps: "Цена / продажби",
      pb: "Цена / счет. стойност",
      evEbitda: "EV / EBITDA",
      divYield: "Дивидентна доходност",
      grossMargin: "Брутен марж",
      opMargin: "Оперативен марж",
      netMargin: "Нетен марж",
      roe: "Възвръщаемост на капитала",
      revGrowth: "Ръст на приходите",
      earnGrowth: "Ръст на печалбата",
      debtEquity: "Дълг / капитал",
      beta: "Бета",
    },
    portfolioAnalytics: {
      totalValue: "Обща стойност",
      totalPl: "Обща П/З",
      annualIncome: "Очакв. годишен доход",
      yieldOnValue: "{pct}% спрямо стойността",
      holdings: "Позиции",
      unconverted: "{n} без конверсия (няма курс)",
      allocationTitle: "Разпределение по позиция",
      sectorTitle: "Разпределение по сектор",
      unknownSector: "Неизвестен",
      moversTitle: "Движения",
      topGainers: "Най-печеливши",
      topLosers: "Най-губещи",
    },
    loading: {
