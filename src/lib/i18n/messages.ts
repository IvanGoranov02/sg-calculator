...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    compare: {
      ...
      intro: "Up to {max} companies side by side. Snapshot cards and grouped metrics — the stronger reading in each row is marked.",
      ...
      leadsHint: "Who stands out in each group from the table below. Not a buy or sell call.",
  ...
  bg: {
    ...
    compare: {
      ...
      intro: "До {max} компании една до друга. Карти и групирани метрики — по-силната стойност на ред е откроена.",
      ...
      leadsTitle: "Накратко",
      leadsHint: "Кой изпъква в групата според таблицата. Не е съвет за покупка или продажба.",
