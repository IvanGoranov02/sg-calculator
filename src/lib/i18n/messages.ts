...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    dashboard: {
      ...
      divOpenPortfolio: "Open portfolio",
      ...
      quickDcfDesc: "GuruFocus-style two-stage DCF, fair value vs market, projection charts.",
  ...
  bg: {
    ...
    dashboard: {
      ...
      divOpenPortfolio: "Отвори портфолио",
      ...
      quickDcfDesc: "Двуетапен DCF в стил GuruFocus, справедлива стойност спрямо пазара, графики.",
