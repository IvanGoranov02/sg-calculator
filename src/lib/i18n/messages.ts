...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    admin: {
      ...
      confirmRefresh:
        "Re-fetch {symbol} from the data sources (SEC EDGAR, or Gemini for non-SEC symbols)? This discards any admin edits and may take a minute.",
    ...
    stock: {
      ...
      subtitle: "Stock analysis · Gemini fundamentals (cached 30 days) + Yahoo live prices",
  ...
  bg: {
    ...
    admin: {
      ...
      confirmRefresh:
        "Повторно изтегляне на {symbol} от източниците (SEC EDGAR, или Gemini за не-SEC символи)? Това изтрива админ редакциите и може да отнеме минута.",
    ...
    stock: {
      ...
      subtitle: "Анализ на акции · Gemini фундаментали (кеш 30 дни) + Yahoo на живо",
