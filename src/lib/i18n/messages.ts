...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    calendar: {
      ...
      intro: "Upcoming earnings dates for the stocks on your watchlist.",
      loading: "Loading earnings dates…",
      error: "Could not load earnings dates.",
      noneUpcoming: "No upcoming earnings dates found for your watchlist.",
      noDate: "No known date ({count})",
      today: "Today",
      tomorrow: "Tomorrow",
      inDays: "in {days} days",
      emptyTitle: "Your watchlist is empty",
      emptyDescBefore: "Add some stocks to your",
      emptyLink: "watchlist",
      emptyDescAfter: " to see their earnings dates here.",
    },
    compare: {
  ...
  bg: {
    ...
    calendar: {
      title: "Календар на отчетите",
      intro: "Предстоящи дати на отчети за акциите в твоя watchlist.",
      loading: "Зареждане на датите…",
      error: "Неуспешно зареждане на датите.",
      noneUpcoming: "Няма предстоящи дати за отчети в твоя watchlist.",
      noDate: "Без известна дата ({count})",
      today: "Днес",
      tomorrow: "Утре",
      inDays: "след {days} дни",
      emptyTitle: "Твоят watchlist е празен",
      emptyDescBefore: "Добави акции към своя",
      emptyLink: "watchlist",
      emptyDescAfter: ", за да видиш датите на отчетите тук.",
    },
    compare: {
