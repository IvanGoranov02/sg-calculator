...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    dcf: {
      ...
      baseHint: "Current per-share base for the DCF (E₀ in the GuruFocus formula).",
      ...
      needInputs: "Enter a positive per-share base and valid stage assumptions.",
  ...
  bg: {
    ...
    dcf: {
      ...
      snapEps: "EPS (прокси)",
      snapEpsSub: "нетна печалба / акции",
      snapFcf: "FCF / акция",
      ...
      baseHint: "Текуща стойност на акция за DCF (E₀ в формулата на GuruFocus).",
      ...
      needInputs: "Въведете положителна стойност на акция и валидни допускания.",
