...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    chartsFund: {
      ...
      range10y: "Last 10 years",
      range5y: "Last 5 years",
      ...
      filterPresetNoNarrow:
        "This window already includes all loaded periods, so the chart matches “All history”.",
  ...
  bg: {
    ...
    chartsFund: {
      ...
      range10y: "Последните 10 години",
      range5y: "Последните 5 години",
      range3y: "Последните 3 години",
      range1y: "Последната година",
      ...
      filterPresetNoNarrow:
        "Този прозорец вече обхваща всички заредени периоди — графиката съвпада с „цялата история“.",
