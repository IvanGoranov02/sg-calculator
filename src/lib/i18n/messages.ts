...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    chartsFund: {
      ...
      chartShareholderDesc: "Cash returned to shareholders when Yahoo reports these lines.",
      ...
      chartDebtEquity: "Debt / equity",
      chartDebtEquityDesc: "Total debt divided by stockholders’ equity.",
  ...
  bg: {
    ...
    chartsFund: {
      ...
      chartShareholderDesc: "Парични потоци към акционери, когато Yahoo ги отчита.",
      ...
      chartDebtEquity: "Дълг / собствен капитал",
      chartDebtEquityDesc: "Общ дълг, разделен на собствения капитал.",
