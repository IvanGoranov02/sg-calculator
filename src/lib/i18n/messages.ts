...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    watchlist: {
      ...
      colDip: "vs 200 SMA",
      dipTitle: "Stock Price vs 200-day Moving Average",
      dipSubtitle:
        "Price vs the SMA of the selected lookback. Red-orange: below average. Blue: above. 200-day SMA stays as a comparison.",
      dipYAxisLabel: "Price vs 200-day Moving Average",
      dipVsSma: "vs 200 SMA",
  ...
  bg: {
    ...
    watchlist: {
      ...
      colDip: "спр. 200 SMA",
      dipTitle: "Цена на акция спрямо 200-дневна плъзгаща средна",
      dipSubtitle:
        "Цена спрямо SMA за избрания период. Червено-оранжево: под средната. Синьо: над. 200-дневната SMA остава за сравнение.",
      dipYAxisLabel: "Цена спрямо 200-дневна плъзгаща средна",
