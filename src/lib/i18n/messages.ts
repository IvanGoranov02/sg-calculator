...
export const messages: Record<AppLocale, MessageDict> = {
  en: {
    ...
    compare: {
      ...
      chartMargins: "Margins & returns",
      chartMarginsHint: "Profitability and growth in percent, side by side.",
      chartMultiples: "Valuation multiples",
      chartMultiplesHint: "Cheaper is usually the lower multiple.",
  ...
  bg: {
    ...
    compare: {
      ...
      chartMargins: "Маржове и възвръщаемост",
      chartMarginsHint: "Рентабилност и растеж в проценти, една до друга.",
      chartMultiples: "Оценителни множители",
      chartMultiplesHint: "Обикновено по-ниският множител е по-евтин.",
